...
//       <div className={`fixed lg:relative top-0 left-0 h-screen bg-gray-800 text-white flex flex-col shadow-lg pt-16 w-72 transform ${isOpen ? "translate-x-0" : "-translate-x-72"} transition-transform duration-300 lg:translate-x-0 lg:w-64`}>
